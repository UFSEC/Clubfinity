...
exports.update = (req,res)=>{
    ...
    if(Object.keys(username).length != 0) {
      ...
      if (props.length == 6 && props[0] == 'fname' && props[1] == 'lname' && props[2] == 'dateOfBirth' && props[3] == 'email' && props[4] == 'username' && props[5] == 'password'){
        userDAO.updateUser(username.id, userInfo);
        res.status(204).send();
      } else {
