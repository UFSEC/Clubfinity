...
import {
  Image, StyleSheet, Text, View, TouchableOpacity, ScrollView, Animated, AsyncStorage, Dimensions,
} from 'react-native';
          ...
          >
            ...
            >
              <View style={style.profileCardRow}>
                ...
                <View>
                  {user && (
                  <Text adjustsFontSizeToFit numberOfLines={2} style={style.textHeader}>
                    {user.name.first}
                    {' '}
                    {user.name.last}
                  </Text>
